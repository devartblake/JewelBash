 ...
 */
UCLASS()
class JEWELBASH_API ATile : public APaperSpriteActor
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintNativeEvent, Category = "Special Game Events")
		void OnMatched(EJewelBashMoveType::Type MoveType);
	virtual void OnMatched_Implementation(EJewelBashMoveType::Type MoveType);
