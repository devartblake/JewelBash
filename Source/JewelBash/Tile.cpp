...
void ATile::OnMatched_Implementation(EJewelBashMoveType::Type MoveType)
{
...
void ATile::StartFalling(bool bUseCurrentWorldLocation)
{
	...
	AJewelBashGameMode* CurrentGameMode = Cast<AJewelBashGameMode>(UGameplayStatics::GetGameMode(this));
