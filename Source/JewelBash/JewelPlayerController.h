...
#include "JewelPlayerController.generated.h"

/**
 * 
 */
UCLASS()
class JEWELBASH_API AJewelPlayerController : public APlayerController
{
	GENERATED_BODY()
	
public:

	AJewelPlayerController(const FObjectInitializer& ObjectInitializer);
